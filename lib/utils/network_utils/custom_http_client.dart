...
class CustomHttpClient {
  ...
  Future<Response> getRequest(String path) async {
    _logger.d(path);
    return await get(Uri.parse(path), headers: await getHeaders());
  }
  ...
  Future<Response> postRequest(
    ...
    Response response = await post(Uri.parse(path),
  ...
  Future<Response> patchRequest(
    ...
    Response response = await patch(Uri.parse(path),
        body: jsonEncode(body), headers: await getHeaders());
    return response;
  }
  ...
  Future<Response> deleteRequest(String path) async {
    _logger.d(path);
    Response response =
        await delete(Uri.parse(path), headers: await getHeaders());
    return response;
  }
}
